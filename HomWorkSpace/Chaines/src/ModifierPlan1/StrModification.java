...
public class StrModification {
	...
	public static void main(String[] args) {
		...
		ChainEndajouter(info, " avec une queue ajoutée.");
		...
		//10-changer caractères majuscule et minuscule
		System.out.println("\nMajuscule en mimuscule : "
				+ car2 + "=>" + Character.toLowerCase(car2)  );

		//11- changer caractères Minuscule en majuscule
	...
	private static void valConvertEntier(char car) {
		...
		System.out.println("\nLe nombre ASCII du caractère [" + car +"] est un entier = " + nbrEntier +".");
