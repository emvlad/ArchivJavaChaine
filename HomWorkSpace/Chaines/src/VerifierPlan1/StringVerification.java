	...
	public static void main(String[] args) {
		...
		if(!strCheck.isEmpty()) {
			...
			//2.1-Vérifier le début de la chaine (boolean startsWith()).
				...
				System.out.println("--ERRORS!- TOUS LES TESTS ONT ÉCHOUÉ.");
			}

		} //fin vide

		//en cas d'échec de la première condition (test initial a échoué).
		else {
			System.out.println("1-La chaine est vide - test initial a échoué. ");
		}

		//3- Comparer deux chaines p3, p4:
		//3.1- Les chaines sont de même contenu (valeur) - equals()
		
		
		//3.1.1- Les chaines sont de même contenu (valeur) - equalsIgnoreCase()
		
		

		//3.2- Les chaines sont de même ordre ASCCI (grandeur) - CompareTo()
		
		
		
		//3.2.1- Les chaines sont de même ordre ASCCI (grandeur) - CompareToIgnoreCase().
