...
public class CheckPoint {
	...
	// méthode statique - type boolean - return?
	...
	//méthode non statique - type boolean - return!
	...
	// Method non static - type void - No return?
		...
		public static void validCharVide(char charVid) {
			if(Character.isWhitespace(charVid)) {
				System.out.println("\nThis character doesn\'t have a value but empty.");
			}
