	...
	//1- décomposer chaine en tableau
		...
		//3.1-Extraire un segment d'une cahine entre deux points fixes
			...
			public void ObtenirPosChar(String chaine, char carLoc) {
				...
				System.out.println("\nLa position pour trouver le caractère \'"+ carLoc + "\' est : " + posCarLoc);
			...
			public static void CopierValTab(char [] tabChar, int indice1, int indice2) {
				...
				System.out.println("\nLa chaine construite avec les valeurs copiées de la table caractère  est : " + strCopier);
