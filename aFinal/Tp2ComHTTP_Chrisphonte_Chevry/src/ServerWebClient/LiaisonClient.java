...
public class LiaisonClient {
	...
	/**
	 * Construire un objet qui représente une connexion du client à partir d'une
	 * socket d'échange. Il initialise le débit d'entrée transmis.
	 */
	LiaisonClient(Socket transmitter) {
		...
		try {
			...
			// embarquer les entrées et sorties
